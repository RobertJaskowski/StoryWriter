...
public class OnDeleteCompleteListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("StoryWriter.Droid.ServiceListeners.OnDeleteCompleteListener, StoryWriter.Android", OnDeleteCompleteListener.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == OnDeleteCompleteListener.class)
			mono.android.TypeManager.Activate ("StoryWriter.Droid.ServiceListeners.OnDeleteCompleteListener, StoryWriter.Android", "", this, new java.lang.Object[] {  });
	}
